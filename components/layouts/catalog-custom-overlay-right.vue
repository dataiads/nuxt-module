...
<template>
    <div class="lg:mx-auto">
        ...
        <div v-if="s.customOverlay.openOverlayButton" class="fixed left-0 lg:left-[280px] transition duration-70 xl:left-[320px] 2xl:left-[360px] right-0 z-[11] bottom-0 lg:top-0 hover:cursor-pointer h-[50px]" @click="openIfClosed">
        ...
        <!-- NEW STYLE OVERLAY -->
        <div id="custom-overlay" class="fixed bottom-0 w-full bg-black/50 z-20 bg-overlay"
            :class="[...s.customOverlay.overlayClass, {'': overlayState === 'closed', 'h-0': overlayState === 'closed', 'h-full': overlayState !== 'closed' }]"
