...
<template>
  <CarouselNext v-if="config.nextButton && displayNext" :class="cn('', arrowPlacement === 'inside' ? 'right-4 z-10' : 'relative left-0 border-none translate-y-0', 'reco-slider-btn', props.class)" :style="config.buttonStyle">
