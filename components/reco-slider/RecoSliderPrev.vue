...
<template>
  <CarouselPrevious v-if="config.previousButton && displayPrev" :class="cn('', arrowPlacement === 'inside' ? 'left-4 z-10' : 'relative left-0 border-none translate-y-0', 'reco-slider-btn', props.class)" :style="config.buttonStyle">
