...
<template>
    ...
    <LayoutsCatalogRecoOverlayRight v-else-if="lpoConfig.variation === 'catalog-reco-overlay-right'" v-bind="props" >
        <template v-for="(_, name) in $slots" #[name]="scope">
            <slot :name="name" v-bind="scope"></slot>
        </template>
    ...
    <LayoutsLightXsellTop v-else-if="lpoConfig.variation === 'light-xsell-top'" v-bind="props" >
        <template v-for="(_, name) in $slots" #[name]="scope">
            <slot :name="name" v-bind="scope"></slot>
        </template>
    </LayoutsLightXsellTop>

    <LayoutsCatalogXsellTop v-else-if="lpoConfig.variation === 'catalog-xsell-top'" v-bind="props" >
        <template v-for="(_, name) in $slots" #[name]="scope">
            <slot :name="name" v-bind="scope"></slot>
        </template>
    </LayoutsCatalogXsellTop>

    <LayoutsCatalogXsellTopNoSlider v-else-if="lpoConfig.variation === 'catalog-xsell-top-no-slider'" v-bind="props" >
        <template v-for="(_, name) in $slots" #[name]="scope">
            <slot :name="name" v-bind="scope"></slot>
        </template>
